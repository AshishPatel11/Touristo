    ...
    <section class="background" style="background-image: url(./images/<?php echo $filenameimg; ?>_banner.jpg);">
        <section class="page3">
            ...
            <div class="place-container1">
                <!-- place 1 Container -->
                <h2 class="pname"><?php echo $data["p1name"]; ?></h2>
                <div class="temp">
                    <p class="place1-desc"><?php echo $data["sub_para1"]; ?></p>
                    <div class="place1-img"
                        style="background-image: url(./images/<?php echo $filenameimg; ?>_place1.jpg);"></div>
                </div>
            </div>
            <div class="place-container2">
                <!-- place 2 Container -->
                <h2 class="pname"><?php echo $data["p2name"]; ?></h2>
                <div class="temp">
            ...
            <div class="place-container3">
                <!-- place 3 Container -->
                <h2 class="pname"><?php echo $data["p3name"]; ?></h2>
                <div class="temp">
            ...
            <div class="place-container4">
                <!-- place 4 Container -->
                <h2 class="pname"><?php echo $data["p4name"]; ?></h2>
                <div class="temp">
            ...
            <div class="place-container5">
                <!-- place 5 Container -->
                <h2 class="pname"><?php echo $data["p5name"]; ?></h2>
                <div class="temp">
            ...
            <div class="place-container6">
                <!-- place 6 Container -->
                <h2 class="pname"><?php echo $data["p6name"]; ?></h2>
                <div class="temp">
        ...
        <footer>
            <div class="part1">
                ...
                <div class="footer-icons">
                    <a href="https://www.instagram.com/ashish_15.65_/"><img class="social-links"
                            src="../css/images/svg/instagram.svg" alt=""></a>
                    ...
                    <a href="mailto:ashishpatel287680@gmail.com"><img class="social-links"
                            src="../css/images/svg/gmail.svg" alt=""></a>
                </div>
                <div class="address">
